...
import 'package:provider_overiview_04/models/Babies.dart';
import 'package:provider_overiview_04/models/dog.dart';
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<Dog>(
          create: (context) => Dog(name: 'dog1', breed: 'dog1', age: 5),
        ),
        FutureProvider(
          initialData: 0,
          create: (context) {
